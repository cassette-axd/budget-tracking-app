...
def create_new_account():
    ...
    email_text = Label(text="Enter Email:")
    email_text.grid(column=0, row=1)

    password_text = Label(text="Enter Password:")
    password_text.grid(column=0, row=2)

    password_text_2 = Label(text="Re-Enter Password:")
    ...
    password_entry_2 = Entry(width=30)
    password_entry_2.grid(column=1, row=3)

    save_info_button = Button(text="Create Account", width=28, command=save_info)
    save_info_button.grid(column=1, row=4)
...
def start_UI():
    ...
    create_account_button = Button(text="Create New Account", width=28, command=create_new_account)
